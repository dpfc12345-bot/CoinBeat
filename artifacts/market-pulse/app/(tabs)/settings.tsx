...
export default function SettingsScreen() {
  ...
  const changeAlerts = async (next: boolean) => {
    ...
    try {
      ...
      if (result.status === 'enabled') {
        ...
        Alert.alert(
          '알림 권한이 필요합니다',
          'Android 설정에서 Market Pulse 알림을 허용하면 알림창에 시세와 뉴스를 고정할 수 있습니다.',
          [
  ...
  return <Screen>
    ...
    <View style={[styles.modeCard, { borderColor: colors.border, backgroundColor: colors.card }]}>
      ...
      <View style={styles.modeCopy}><Text style={[styles.modeTitle, { color: colors.foreground }]}>실시간 데이터 모드</Text><Text style={[styles.modeText, { color: colors.mutedForeground }]}>Upbit 시세와 블록미디어 RSS를 사용합니다.</Text></View>
      <View style={[styles.liveBadge, { borderColor: colors.primary }]}><Text style={[styles.liveText, { color: colors.primary }]}>실시간</Text></View>
    </View>
